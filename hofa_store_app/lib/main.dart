...
class _HofaStoreAppState extends ConsumerState<HofaStoreApp> {
  ...
  Future<void> _checkPwaInstall() async {
    ...
    final install = await showDialog<bool>(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Cài đặt HOFA Store lên máy?'),
        content: Text(
          canPromptNative
              ? 'Thêm HOFA Store vào màn hình chính để mở nhanh hơn, dùng như ứng dụng thật và nhận được thông báo đơn hàng.'
              : 'Nhấn nút Chia sẻ ở thanh trình duyệt, sau đó chọn "Thêm vào MH chính" để dùng HOFA Store như ứng dụng thật và nhận được thông báo đơn hàng.',
        ),
        actions: [
          TextButton(
