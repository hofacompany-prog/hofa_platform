...
/// riêng). Cập nhật thời gian thực qua push FCM (PushService.chatMessageStream) — tin mới tự
/// chèn vào ngay khi push tới, không cần đợi hết vòng polling (vẫn giữ polling mỗi 5 giây làm
/// lưới an toàn). Đóng nhắn tin (window hết hạn/đơn đã huỷ) thì ẩn ô nhập, chỉ xem lại lịch sử
