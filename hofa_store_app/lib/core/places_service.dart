...
/// định danh app, và không gọi dồn dập (đã debounce ở màn hình chọn vị trí) — đủ dùng
/// cho MVP, nếu lượng truy cập lớn về sau nên đổi sang 1 nhà cung cấp trả phí.
class PlacesService {
