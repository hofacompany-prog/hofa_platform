...
class PushService {
  ...
  Future<void> init(GlobalKey<NavigatorState> navigatorKey) async {
    ...
    await _local
        ...
        ?.createNotificationChannel(const AndroidNotificationChannel(
          'order_offers',
          'Đơn hàng',
          description: 'Thông báo đơn mới, đơn tự xác nhận, đơn tự huỷ do quá hạn',
  ...
  Future<void> _onForegroundMessage(RemoteMessage message) async {
    ...
    if (title != null) {
      await _local.show(
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails('order_offers', 'Đơn hàng', importance: Importance.max, priority: Priority.high),
    ...
    if (message.data['type'] == 'order_offer') _handleData(message.data);
  }
