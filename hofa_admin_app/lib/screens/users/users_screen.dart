              ...
              children: [
                Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    onSelected: (_) => ref.read(userRoleFilterProvider.notifier).state = null,
                  ),
                ),
                ...roleLabels.entries.map((e) => Padding(
                      padding: const EdgeInsets.only(right: 8),
                      child: ChoiceChip(
                        label: Text(e.value),
                        selected: roleFilter == e.key,
                        onSelected: (_) => ref.read(userRoleFilterProvider.notifier).state = e.key,
                      ),
                    )),
              ],
            ),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: Icon(blocked ? Icons.block : Icons.person,
                              color: blocked ? theme.colorScheme.error : theme.colorScheme.primary),
                        ),
                        title: Text(u.fullName, style: const TextStyle(fontWeight: FontWeight.w500)),
                        subtitle: Text('${u.phone}${u.email != null ? ' · ${u.email}' : ''}'),
                        trailing: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Chip(
                            ...
                            PopupMenuButton<String>(
                              ...
                              itemBuilder: (context) => [
                                const PopupMenuItem(value: 'role', child: Text('Đổi vai trò')),
                                PopupMenuItem(
                                  value: 'block',
                                  child: Text(blocked ? 'Mở khoá tài khoản' : 'Tạm khoá tài khoản'),
                                ),
                              ],
                            ),
                          ],
