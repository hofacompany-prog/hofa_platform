...
/// Material mặc định. [color] luôn truyền rõ từ nơi gọi (không đọc IconTheme.of(context) —
/// đã xác nhận NavigationRail/NavigationBar không tô đúng màu cho widget con tuỳ ý qua
/// IconThemeData ambient như kỳ vọng, chỉ đáng tin cậy với Icon() dựng sẵn).
class TabIcon extends StatelessWidget {
  final String? url;
  final IconData fallback;
  final Color color;
  const TabIcon({super.key, this.url, required this.fallback, required this.color});
