...
/// Toàn bộ icon Material Design cơ bản (không tính các biến thể sharp/rounded/outlined
/// để đỡ trùng lặp cùng 1 icon) — icon_name lưu đúng tên hằng số này (vd 'restaurant',
/// 'devices') vào cột categories.icon_name. Sinh tự động từ mã nguồn Flutter SDK
/// (packages/flutter/lib/src/material/icons.dart). Phải khai báo giống hệt ở admin lẫn
/// customer app (2 file trùng nhau, không import chéo được giữa 2 project).
...
String categoryIconLabel(String name) => name.replaceAll('_', ' ');
