...
class DriverAcceptSettings {
  ...
  factory DriverAcceptSettings.fromJson(Map<String, dynamic> json) => DriverAcceptSettings(
        ...
        offerReminderIntervalSeconds: (json['offer_reminder_interval_seconds'] as num?)?.toInt() ?? 5,
      );
