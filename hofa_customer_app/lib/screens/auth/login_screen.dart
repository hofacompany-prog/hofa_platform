  ...
  Future<void> _submit() async {
    ...
    if (_isSignUp) {
      ...
      setState(() {
        _awaitingOtp = true;
        _error = null;
        _info = 'Đã gửi mã xác thực tới $_phoneDisplay. Tạm thời dùng mã 123123.';
      });
      return;
    }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_awaitingOtp) ...[
                            Text('Nhập mã OTP đã gửi tới $_phoneDisplay', style: theme.textTheme.bodySmall),
                            ...
                            TextFormField(
                              ...
                              decoration:
                                  const InputDecoration(labelText: 'Số điện thoại', border: OutlineInputBorder()),
                              keyboardType: TextInputType.phone,
                              validator: (v) =>
                                  (v == null || !isValidPhone(v.trim())) ? 'Số điện thoại không hợp lệ' : null,
                            ),
                            const SizedBox(height: 16),
                            TextFormField(
