...
/// chọn — NavigationBar tự set IconTheme khác nhau cho icon đang chọn và chưa chọn, áp dụng
/// cho MỌI widget con (không riêng gì Icon), nên chỉ cần đọc lại đúng màu đó là khớp hệt hành
/// vi icon Material gốc.
