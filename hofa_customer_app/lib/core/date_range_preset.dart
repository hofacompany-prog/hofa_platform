...
/// Khoảng thời gian nhanh cho danh sách đơn hàng — khách/cửa hàng bắt buộc chọn 1 trong 4 (xem
...
enum DateRangePreset {
  ...
  /// theo giờ Việt Nam ở GET /orders/mine (AT TIME ZONE 'Asia/Ho_Chi_Minh').
