...
/// client.navigate() nhưng KHÔNG phải lúc nào cũng khiến trang tải lại thật (xác nhận qua thực
/// tế bên store app) — service worker vẫn ghi path vào IndexedDB như bình thường rồi
/// postMessage cho trang đang mở, index.html gọi lại hàm này để app tự đọc lại + điều hướng
/// bằng router hiện có, không phụ thuộc navigate() có tải lại trang hay không.
